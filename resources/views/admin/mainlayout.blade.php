        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="min-width: 200px">
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  <span class="mx-3"><i class="fas fa-user"></i></span>
                  Profile
                </h3>
          ...
          <a href="{{route('logout')}}" class="dropdown-item">
            ...
            <div class="media">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  <span class="mx-3"><i class="fa fa-power-off"></i></span>
                  Logout
                </h3>
...
<aside class="main-sidebar sidebar-dark-primary elevation-4 mb-4">
  ...
  <a href="{{route('dashboard')}}" class="brand-link">
    ...
    <span class="brand-text font-weight-light">Astrologer</span>
  </a>
